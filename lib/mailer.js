              ...
              <td style="padding:32px;">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-bottom:24px;">
                  <tr>
                    ...
                    <td style="padding:12px 16px;border:1px solid #e5e7eb;font-size:14px;font-weight:600;">13 June 2026</td>
                  </tr>
                  <tr>
                ...
                <p style="margin:0 0 24px;font-size:14px;line-height:1.5;">
                  <a href="https://us06web.zoom.us/j/83251675474?pwd=53rAMdpxIotHheZ26QIpqV9VTABsFO.1" style="color:#0f766e;word-break:break-all;">https://us06web.zoom.us/j/83251675474?pwd=53rAMdpxIotHheZ26QIpqV9VTABsFO.1</a>
                </p>
  ...
  const response = await axios.post(
    'https://api.brevo.com/v3/smtp/email',
    {
      ...
      textContent:
        ...
        `https://us06web.zoom.us/j/83251675474?pwd=53rAMdpxIotHheZ26QIpqV9VTABsFO.1\n\n` +
        `We recommend joining a few minutes early to ensure a smooth experience.\n\n` +
